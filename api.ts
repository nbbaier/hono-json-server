export const openapi = {
  ...
  info: {
    title: "Val Town API";
    description: "The Val Town API provides services to evaluate JavaScript and TypeScript expressions, run vals as APIs, either as functions or Express handlers.\n\nLearn more at [https://docs.val.town](https://docs.val.town)\n";
    version: "1.5.1";
  };
  servers: [
    {
      ...
      val_name: {
        ...
        examples: {
          id: {
            value: "id";
            summary: "id";
            description: "This val is a function that returns its arguments. It is useful for testing how the API handles the arguments passed to it.\n\nView the val at [https://val.town/v/stevekrouse.id](https://val.town/v/stevekrouse.id)\n";
          };
        };
      };
      version: {
